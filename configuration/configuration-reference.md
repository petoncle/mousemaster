...
# All hint1-mode.hint.font-* properties exist for hint1-mode.hint.prefix-font-*,
# e.g. hint1-mode.hint.prefix-font-name=Arial
hint1-mode.hint.selected-font-color=#A3A3A3
