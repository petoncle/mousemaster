...
//            Gdiplus.GdiplusRectF textSize = new Gdiplus.GdiplusRectF();
//            measureString(text, normalFont, graphics, layoutRect, textSize, stringFormat, region);
